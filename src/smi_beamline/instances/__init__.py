...
DEVICE_MODULES = [
    ...
    ("manipulators",   "smi_beamline.instances.manipulators"),
    ("mirrors",        "smi_beamline.instances.mirrors"),
    ("motors",         "smi_beamline.instances.motors"),
    ("slits",          "smi_beamline.instances.slits"),
    ("energy",         "smi_beamline.instances.energy"),
    ("xbpms",          "smi_beamline.instances.xbpms"),
    ("ioLogik",        "smi_beamline.instances.ioLogik"),
    ("electrometers",  "smi_beamline.instances.electrometers"),
    ("amptek",         "smi_beamline.instances.amptek"),
    ("pilatus",        "smi_beamline.instances.pilatus"),
    ("prosilica",      "smi_beamline.instances.prosilica"),
    ("beam modes",     "smi_beamline.instances.beam"),
    ...
    ("blade coater",   "smi_beamline.instances.bladecoater"),
    ("humidity cell",  "smi_beamline.plans.humidity_cell"),
    ("linkam",         "smi_beamline.instances.linkam"),
    ("suspenders",     "smi_beamline.instances.suspenders"),
