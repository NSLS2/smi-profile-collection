...
from smi_beamline.instances.pilatus import pil2m_pos
from smi_beamline.instances.beamstop import saxs_bs
from smi_beamline.devices import _context
RE = _context.get_re()
from smi_beamline.instances.attenuators import (att1_1, att1_2, att1_3, att1_4, att1_5, att1_6, att1_7, att1_8, att1_9, att1_10, att1_11, att1_12,
...
from smi_beamline.instances.pilatus import waxs, pil2M, pil900KW
from smi_beamline.instances.beamstop import saxs_bs
from smi_beamline.instances.crls import crl
from smi_beamline.instances.waxschamber import get_chamber_pressure, chamber_pressure
...
class SMI_Beamline(Beamline): # used in alignment
    ...
    def setReflectedBeamROI(self, total_angle=0.16, technique="gisaxs", size=[48, 8],
        ...
        if technique == "gisaxs":
            ...
            # Define the reflected beam ROI on the pilatus 2M detector
            yield from bps.mv(roi.min_xyz.min_x, int(x_pos))
